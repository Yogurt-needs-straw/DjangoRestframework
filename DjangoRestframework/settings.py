...
SECRET_KEY = 'django-insecure-!2c&-hy+rsf8466t%#=b^fk*n588^&kjb!k5gkai+z6-n$y54$'
...
REST_FRAMEWORK = {
    ...
    "EDFAULT_PARSER_CLASSES": ["rest_framework.parsers.JSONParser"],  # 默认传送JSON格式
